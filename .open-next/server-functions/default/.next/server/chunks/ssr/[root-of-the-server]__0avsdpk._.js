module.exports=[93695,(a,b,c)=>{b.exports=a.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},56369,a=>{"use strict";var b=a.i(7997),c=a.i(95936),d=a.i(44425),e=a.i(66879);async function f(){let a=await (0,e.getPublishedArticles)();return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(d.default,{}),(0,b.jsxs)("main",{className:"min-h-screen bg-white text-[#0D1A63]",children:[(0,b.jsx)("section",{className:"bg-[#0D1A63] px-6 py-20 text-white lg:px-8",children:(0,b.jsxs)("div",{className:"mx-auto max-w-5xl text-center",children:[(0,b.jsx)("p",{className:"text-sm font-semibold uppercase tracking-[0.2em] text-[#F68048]",children:"Articles"}),(0,b.jsx)("h1",{className:"mt-4 text-4xl font-bold leading-tight sm:text-5xl",children:"Insights, Strategies & Digital Marketing Knowledge"}),(0,b.jsx)("p",{className:"mx-auto mt-6 max-w-3xl text-lg leading-8 text-blue-100",children:"Explore practical insights about social media marketing, content creation, advertising, SEO, analytics, and AI-powered digital marketing."})]})}),(0,b.jsx)("section",{className:"px-6 py-16 lg:px-8",children:(0,b.jsx)("div",{className:"mx-auto max-w-6xl",children:0===a.length?(0,b.jsxs)("div",{className:"rounded-2xl border border-slate-200 bg-slate-50 p-10 text-center",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-[#0D1A63]",children:"Articles Coming Soon"}),(0,b.jsx)("p",{className:"mt-3 text-slate-600",children:"New articles and digital marketing insights will be published here soon."})]}):(0,b.jsx)("div",{className:"grid gap-8 md:grid-cols-2 lg:grid-cols-3",children:a.map(a=>(0,b.jsxs)("article",{className:"group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl",children:[(0,b.jsx)("div",{className:"relative aspect-[16/10] overflow-hidden bg-slate-100",children:a.featured_media_storage_key?(0,b.jsx)("img",{src:`/api/assets?key=${encodeURIComponent(a.featured_media_storage_key)}`,alt:a.featured_media_alt_text||a.title,className:"h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]"}):(0,b.jsx)("div",{className:"flex h-full items-center justify-center",children:(0,b.jsx)("span",{className:"text-sm font-semibold text-slate-400",children:"Article"})})}),(0,b.jsxs)("div",{className:"p-7",children:[(0,b.jsxs)("div",{className:"flex flex-wrap items-center gap-2 text-xs font-bold uppercase tracking-wide",children:[a.category&&(0,b.jsx)("span",{className:"rounded-full bg-blue-50 px-3 py-1 text-[#2845D6]",children:a.category}),a.published_at&&(0,b.jsx)("span",{className:"text-slate-400",children:a.published_at})]}),(0,b.jsx)("h2",{className:"mt-4 text-2xl font-bold text-[#0D1A63]",children:a.title}),a.excerpt&&(0,b.jsx)("p",{className:"mt-4 leading-7 text-slate-600",children:a.excerpt}),(0,b.jsx)("div",{className:"mt-6",children:(0,b.jsxs)(c.default,{href:`/articles/${a.slug}`,className:"inline-flex items-center rounded-lg bg-[#2845D6] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#1A2CA3] hover:shadow-md",children:["Read Article",(0,b.jsx)("span",{className:"ml-2",children:"→"})]})})]})]},a.id))})})})]})]})}a.s(["default",0,f])},44736,function(a){a.n(a.i(56369))},26758,a=>{a.v("/_next/static/media/favicon.2vob68tjqpejf.ico"+(globalThis.NEXT_CLIENT_ASSET_SUFFIX||""))},38872,a=>{"use strict";let b={src:a.i(26758).default,width:256,height:256};a.s(["default",0,b])},98677,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/Navbar.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/Navbar.tsx","default")},44425,a=>{"use strict";var b=a.i(98677);a.n(b)},66879,a=>{"use strict";let b=Symbol.for("__cloudflare-context__");function c(a={async:!1}){return a.async?e():function(){let a=d();if(a)return a;if(function(){let a=globalThis;return a.__NEXT_DATA__?.nextExport===!0}())throw Error("\n\nERROR: `getCloudflareContext` has been called in sync mode in either a static route or at the top level of a non-static one, both cases are not allowed but can be solved by either:\n  - make sure that the call is not at the top level and that the route is not static\n  - call `getCloudflareContext({async: true})` to use the `async` mode\n  - avoid calling `getCloudflareContext` in the route\n");throw Error(g)}()}function d(){return globalThis[b]}async function e(){let a=d();if(a)return a;{var c;let a=await f();return c=a,globalThis[b]=c,a}}async function f(a){let{getPlatformProxy:b}=await import(`${"__wrangler".replaceAll("_","")}`),c=a?.environment??process.env.NEXT_DEV_WRANGLER_ENV,{env:d,cf:e,ctx:f}=await b({...a,envFiles:[],environment:c});return{env:d,cf:e,ctx:f}}let g=`
