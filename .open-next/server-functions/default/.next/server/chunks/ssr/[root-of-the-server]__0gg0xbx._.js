module.exports=[93695,(a,b,c)=>{b.exports=a.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},26758,a=>{a.v("/_next/static/media/favicon.2vob68tjqpejf.ico"+(globalThis.NEXT_CLIENT_ASSET_SUFFIX||""))},38872,a=>{"use strict";let b={src:a.i(26758).default,width:256,height:256};a.s(["default",0,b])},29031,a=>{"use strict";var b=a.i(7997),c=a.i(44425),d=a.i(66879);async function e(){let a=await (0,d.getPublishedServices)();return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(c.default,{}),(0,b.jsxs)("main",{className:"min-h-screen bg-white",children:[(0,b.jsx)("section",{className:"bg-[#0D1A63] px-6 py-24 text-white lg:px-8",children:(0,b.jsxs)("div",{className:"mx-auto max-w-7xl",children:[(0,b.jsx)("p",{className:"text-sm font-semibold uppercase tracking-[0.2em] text-[#F68048]",children:"Services"}),(0,b.jsx)("h1",{className:"mt-4 max-w-4xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl",children:"Digital marketing services designed for growth."}),(0,b.jsx)("p",{className:"mt-6 max-w-2xl text-lg leading-8 text-blue-100",children:"I combine strategy, creative content, paid advertising, and analytics to help businesses build stronger digital brands and make better marketing decisions."})]})}),(0,b.jsx)("section",{className:"px-6 py-20 lg:px-8",children:(0,b.jsx)("div",{className:"mx-auto max-w-7xl",children:0===a.length?(0,b.jsxs)("div",{className:"rounded-2xl border border-slate-200 bg-slate-50 p-10 text-center",children:[(0,b.jsx)("h2",{className:"text-xl font-bold text-[#0D1A63]",children:"No services available"}),(0,b.jsx)("p",{className:"mt-3 text-slate-600",children:"Published services will appear here."})]}):(0,b.jsx)("div",{className:"grid gap-6 md:grid-cols-2 lg:grid-cols-3",children:a.map(a=>(0,b.jsxs)("article",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl",children:[(0,b.jsx)("span",{className:"text-sm font-bold text-[#F68048]",children:String(a.sort_order).padStart(2,"0")}),(0,b.jsx)("h2",{className:"mt-6 text-xl font-bold text-[#0D1A63]",children:a.title}),(0,b.jsx)("p",{className:"mt-4 leading-7 text-slate-600",children:a.short_description||a.description||"More information about this service will be available soon."})]},a.id))})})})]})]})}a.s(["default",0,e])},17462,function(a){a.n(a.i(29031))},98677,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/Navbar.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/Navbar.tsx","default")},44425,a=>{"use strict";var b=a.i(98677);a.n(b)},66879,a=>{"use strict";let b=Symbol.for("__cloudflare-context__");function c(a={async:!1}){return a.async?e():function(){let a=d();if(a)return a;if(function(){let a=globalThis;return a.__NEXT_DATA__?.nextExport===!0}())throw Error("\n\nERROR: `getCloudflareContext` has been called in sync mode in either a static route or at the top level of a non-static one, both cases are not allowed but can be solved by either:\n  - make sure that the call is not at the top level and that the route is not static\n  - call `getCloudflareContext({async: true})` to use the `async` mode\n  - avoid calling `getCloudflareContext` in the route\n");throw Error(g)}()}function d(){return globalThis[b]}async function e(){let a=d();if(a)return a;{var c;let a=await f();return c=a,globalThis[b]=c,a}}async function f(a){let{getPlatformProxy:b}=await import(`${"__wrangler".replaceAll("_","")}`),c=a?.environment??process.env.NEXT_DEV_WRANGLER_ENV,{env:d,cf:e,ctx:f}=await b({...a,envFiles:[],environment:c});return{env:d,cf:e,ctx:f}}let g=`
