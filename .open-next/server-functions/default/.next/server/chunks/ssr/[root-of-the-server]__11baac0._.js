module.exports=[93695,(a,b,c)=>{b.exports=a.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},15517,a=>{"use strict";var b=a.i(7997);a.i(70396);var c=a.i(73727),d=a.i(95936),e=a.i(44425),f=a.i(66879);async function g({params:a}){let{slug:h}=await a,i=await (0,f.getPublishedArticleBySlug)(h);return i||(0,c.notFound)(),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(e.default,{}),(0,b.jsxs)("main",{className:"min-h-screen bg-white text-[#0D1A63]",children:[(0,b.jsx)("section",{className:"bg-[#0D1A63] px-6 py-20 text-white lg:px-8",children:(0,b.jsxs)("div",{className:"mx-auto max-w-4xl",children:[i.category&&(0,b.jsx)("p",{className:"text-sm font-semibold uppercase tracking-[0.2em] text-[#F68048]",children:i.category}),(0,b.jsx)("h1",{className:"mt-4 text-4xl font-bold leading-tight sm:text-5xl",children:i.title}),(0,b.jsxs)("div",{className:"mt-6 flex flex-wrap gap-4 text-sm text-blue-100",children:[i.author&&(0,b.jsxs)("span",{children:["By ",i.author]}),i.published_at&&(0,b.jsxs)("span",{children:["Published: ",i.published_at]})]})]})}),(0,b.jsx)("section",{className:"px-6 py-16 lg:px-8",children:(0,b.jsxs)("div",{className:"mx-auto max-w-4xl",children:[i.featured_media_storage_key&&(0,b.jsxs)("figure",{className:"mb-10 overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 shadow-sm",children:[(0,b.jsx)("img",{src:`/api/assets?key=${encodeURIComponent(i.featured_media_storage_key)}`,alt:i.featured_media_alt_text||i.title,className:"h-auto max-h-[650px] w-full object-cover"}),i.featured_media_caption&&(0,b.jsx)("figcaption",{className:"border-t border-slate-200 px-6 py-4 text-sm leading-6 text-slate-600",children:i.featured_media_caption})]}),i.excerpt&&(0,b.jsx)("div",{className:"mb-10 rounded-2xl border-l-4 border-[#F68048] bg-slate-50 p-6",children:(0,b.jsx)("p",{className:"text-lg leading-8 text-slate-600",children:i.excerpt})}),i.content&&(0,b.jsx)("article",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10",children:(0,b.jsx)("div",{className:"whitespace-pre-line text-lg leading-9 text-slate-700",children:i.content})}),(0,b.jsx)("div",{className:"mt-10",children:(0,b.jsx)(d.default,{href:"/articles",className:"inline-flex items-center rounded-lg border border-[#2845D6] px-5 py-3 text-sm font-semibold text-[#2845D6] transition hover:bg-[#2845D6] hover:text-white",children:"← Back to Articles"})})]})})]})]})}a.s(["default",0,g])},47962,function(a){a.n(a.i(15517))},26758,a=>{a.v("/_next/static/media/favicon.2vob68tjqpejf.ico"+(globalThis.NEXT_CLIENT_ASSET_SUFFIX||""))},38872,a=>{"use strict";let b={src:a.i(26758).default,width:256,height:256};a.s(["default",0,b])},98677,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/Navbar.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/Navbar.tsx","default")},44425,a=>{"use strict";var b=a.i(98677);a.n(b)},66879,a=>{"use strict";let b=Symbol.for("__cloudflare-context__");function c(a={async:!1}){return a.async?e():function(){let a=d();if(a)return a;if(function(){let a=globalThis;return a.__NEXT_DATA__?.nextExport===!0}())throw Error("\n\nERROR: `getCloudflareContext` has been called in sync mode in either a static route or at the top level of a non-static one, both cases are not allowed but can be solved by either:\n  - make sure that the call is not at the top level and that the route is not static\n  - call `getCloudflareContext({async: true})` to use the `async` mode\n  - avoid calling `getCloudflareContext` in the route\n");throw Error(g)}()}function d(){return globalThis[b]}async function e(){let a=d();if(a)return a;{var c;let a=await f();return c=a,globalThis[b]=c,a}}async function f(a){let{getPlatformProxy:b}=await import(`${"__wrangler".replaceAll("_","")}`),c=a?.environment??process.env.NEXT_DEV_WRANGLER_ENV,{env:d,cf:e,ctx:f}=await b({...a,envFiles:[],environment:c});return{env:d,cf:e,ctx:f}}let g=`
